...
export const TABLE_ACTIVE_REQUEST = 'TABLE_ACTIVE_REQUEST'
export const TABLE_ACTIVE_SUCCESS = 'TABLE_ACTIVE_SUCCESS'
export const TABLE_ACTIVE_FAIL = 'TABLE_ACTIVE_FAIL'
